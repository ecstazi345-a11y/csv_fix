...
MENU_TITLE_OVERRIDES: dict[str, str] = {
    ...
    "24_Реестр_ограничений_допуска_месячного_плана.py": "Реестр ограничений допуска месячного плана",
    ...
    "51_AI_Оркестратор_месячного_плана.py": "Оркестратор месячного плана",
    "52_Архитектура_агентной_оркестрации_месячного_плана.py": "Архитектура агентной оркестрации контура месячного планирования",
    "53_AI_Центр_управления_агентами.py": "Центр управления агентами",
}
...
NAV_SECTIONS: dict[str, list[str]] = {
    ...
    "▌ Контур агентной оркестрации": [
        "50_AI_Агенты.py",
        "51_AI_Оркестратор_месячного_плана.py",
        "52_Архитектура_агентной_оркестрации_месячного_плана.py",
        "53_AI_Центр_управления_агентами.py",
    ],
}
