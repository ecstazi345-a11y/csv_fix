-- =============================================================================
-- BACKUP ONLY — 30 technical duplicate DELETE candidates
-- Table: public.monthly_plan_lines_v2_deleted_backup_20260728
-- Run inside transaction with delete script, or before delete-only script.
...
create index if not exists monthly_plan_lines_v2_deleted_backup_20260728_src_idx
  on public.monthly_plan_lines_v2_deleted_backup_20260728 (source_plan_line_id);
...
select
  now(),
  'technical_duplicate_cleanup_20260728',
  null::uuid,
  null::text,
  p.plan_line_id,
  to_jsonb(p)
